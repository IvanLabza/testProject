export const PL = {
  joinNow:
    'DOŁĄCZ TERAZ! ZAREJESTRUJ SIĘ W SYSTEMIE NATYCHMIAST, ABY ZABEZPIECZYĆ SWOJE MIEJSCE!',
  discover: 'Odkryj ścieżkę do finansowego dobrobytu!',
  fullName: 'Pełne imię',
  lastName: 'Nazwisko',
  ...
  achieveYourFinancialTriumph:
    'Osiągnij swój finansowy tryumf: Platforma Turing Machine AI zamienia małe inwestycje w ogromne zyski!',
};

export const DE = {
  joinNow:
    'JETZT BEITRETEN! REGISTRIEREN SIE SICH SOFORT IM SYSTEM, UM IHREN PLATZ ZU SICHERN!',
  discover: 'Entdecken Sie den Weg zum finanziellen Überfluss!',
  ...
  achieveYourFinancialTriumph:
    'Erreichen Sie Ihren finanziellen Triumph: Die Turing Machine AI-Plattform verwandelt kleine Investitionen in massive Gewinne!',
};

export const ES = {
  joinNow:
    '¡ÚNETE AHORA! REGÍSTRATE INMEDIATAMENTE EN EL SISTEMA PARA ASEGURAR TU LUGAR!',
  discover: '¡Descubre el camino hacia la abundancia financiera!',
  ...
  achieveYourFinancialTriumph:
    'Logra tu triunfo financiero: ¡La plataforma Turing Machine AI convierte pequeñas inversiones en ganancias masivas!',
};

export const EN = {
  joinNow: 'JOIN NOW! REGISTER IN THE SYSTEM IMMEDIATELY TO SECURE YOUR SPOT!',
  discover: 'Discover the path to financial abundance!',
  fullName: 'Full Name',
  lastName: 'Last Name',
  ...
  signUp: 'SIGN UP',
  byRegistering:
    'By registering, I confirm that I have read and agree to the terms of service and privacy policy outlined on the website.',
  restAssuredSpan:
    'Rest assured, your data is always securely protected with us.',
  restAssuredText:
    ' Feel free to update your preferences at any time by using the unsubscribe link in the bottom of any email you receive from us. We take your privacy seriously and handle your information with the utmost care. By clicking the button above, you consent to the processing of your information in accordance with these terms.',
  netCurrentRevenue: 'Net Current Revenue:',
  commonProfitsToday: 'Common Profits Today 10/05/23:',
  hurry: 'Hurry! Only 13 spots remaining for new participants!',
  achieveYourFinancialTriumph:
    'Achieve Your Financial Triumph: Turing Machine AI platform turns small investments into massive earnings!',
};
